...
class ProfessorComplaintController extends Controller
{
    ...
    public function getProfessorComplaintsByUserId(int $userId): JsonResponse
    {
        try {
    ...
    public function storeProfessorComplaint(StoreComplaintRequest $request): JsonResponse
    {
        try {
